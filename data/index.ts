...
export const navItems = [
  ...
  { name: "Contact", link: "#footer", id:4 },
];

export const gridItems = [
  {
    id: 1,
    title: "I prioritise open communication and collaboration in groupwork",
    description: "",
...
export const featureprojects = [
  {
    ...
    des: "Being developed in conjunction with A*STAR and SGH along 3 other teammates, to mitigate risk of misdiagnoses of medical issues.",
    img: "/biiPortfolio.jpeg",
    iconLists: ["python.svg","jupyter.svg","scikit-learn-seeklogo.svg"],
    opt: "AI Model to save lives"
  },
  {
    id: 2,
    title: "Automatic Piil Dispensor",
    des: "Developed at a hackathon-styled event in a team, with the aim of ensuring adherence to medical prescriptions in elderly populations. ",
    img: "/sutdPortfolio.jpeg",
    iconLists: ["arduino.svg","cpp_logo.svg"],
    opt: "Uses Arduino Micro-controller"
  ...
  },
  {
    ...
    des: "Using past recorded population data and scikit-learn machine learning library to predict future population size",
    img: "/popPredict.png",
    iconLists: ["python.svg", "jupyter.svg", "/scikit-learn-seeklogo.svg"],
    link: url1,
    opt: url1,
...
export const projects = [
  ...
  },
  {
    ...
    opt: "Textfighter in Python",
  },
  {
    id: 6,
    title: "Portfolio Website",
    des: "Made by following a tutorial as well as adding my personal touch to it, to customise it for my purposes. Hosted on Vercel.",
...
export const testimonials = [
  ...
  },
  {
    ...
    title: "2-Day Hackathon Styled camp where my team desigend a solution for young technopreneurs lacking ways to platform themselves",
  },
  {
    quote: "/sieberrsecCert.png",
    name: "Sieberrsec CTF",
    title: "Achieved 12th place in this DSTA-Sponsored cybersecurity competition",
  },
  {
    quote: "/b1.svg",
